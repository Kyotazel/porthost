...
class CategoryMenuDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\CategoryMenu $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CategoryMenu $model): QueryBuilder
    {
    ...
    {
        return 'CategoryMenu_' . date('YmdHis');
    }
}
